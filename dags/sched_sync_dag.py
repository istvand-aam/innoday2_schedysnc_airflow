...
from src.sched_sync_functions import pull_pos_feed, create_playlists, create_schedules, cleanup_schedules
...
task_cleanup_previous_schedules = PythonOperator(
    task_id='cleanup_schedules',
    python_callable=cleanup_schedules,
    start_date=MANANA,
    op_kwargs={},
    dag=SchedSyncDAG
)
...
# task_create_playlists.set_upstream(task_pull_pos_feed)
